...
if __name__ == '__main__':
    ...
    grid_variable = 'grid_cell_100x100'
    ...
    score_xgb, time_xgb = process_grid(train, test, threshold = xgb_threshold, grid_ids = grid_ids, model = model_xgb, grid_variable = grid_variable)   
